...
function displayTasks(tasks) {
    ...
    if (tasks.length === 0) {
        container.innerHTML = '<p class="text-center text-muted">No tienes tareas registradas</p>';
        return;
    }
        ...
        html += `
            <div class="card task-card ${task.status} mb-3">
                <div class="card-body">
                    ...
                    <div class="mt-3">
                        <button class="btn btn-sm btn-primary" onclick="editTask1(${task.id})">Editar</button>
